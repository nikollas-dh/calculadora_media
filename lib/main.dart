...
void calcularMedia(){
  ...
  String sitacaoCalculada;

  if(mediaCalculada>=6) {
    sitacaoCalculada="APROVADO";
    }
  else if (mediaCalculada==5) {
    sitacaoCalculada="RECUPERAÇÃO";
    }
  else  {
    sitacaoCalculada="REPROVADO";
    }
  ...
  setState(() {
   ...
   situacao=sitacaoCalculada; 
   maiorNota = ExibirMaiorNota(nota1, nota2, nota3, nota4);
  });
}
 ExibirMaiorNota(double nota1,double nota2,double nota3,double nota4){
  double maiorNota;
  if(nota1>nota2 && nota1>nota3 && nota1>nota4){
    return maiorNota =nota1;
  }
  else if(nota2>nota1 && nota2>nota3 && nota2>nota4){
    return maiorNota =nota2;
  }
  else if(nota3>nota1 && nota3>nota2 && nota3>nota4){
    return maiorNota = nota4;
  }
  else{
    return maiorNota=nota4;
  }
